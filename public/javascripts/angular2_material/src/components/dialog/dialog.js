  ...
  return {
    ...
    execute: function() {
      ...
      MdDialog = $__export("MdDialog", (($traceurRuntime.createClass)(function(loader, domRenderer) {
        ...
        open: function(type, elementRef) {
          var options = arguments[2] !== (void 0) ? arguments[2] : null;
          var $__0 = this;
          ...
          return this.componentLoader.loadNextToLocation(MdDialogContainer, elementRef).then((function(containerRef) {
            ...
            return $__0.componentLoader.loadNextToLocation(type, containerRef.instance.contentRef, bindings).then((function(contentRef) {
        ...
        _openBackdrop: function(elementRef, bindings) {
          var $__0 = this;
          return this.componentLoader.loadNextToLocation(MdBackdrop, elementRef, bindings).then((function(componentRef) {
